...
float modeRange[NUM_MODES - 1] =  //НАСТРОЙКА: границы диапазонов крена - в градусах - «0» не включать!
...
void loop() {  //===========  LOOP =============
  ...
  //  EVERY_MS(10) {          //НАСТРОЙКА Каждые столько мс обновляем значения
